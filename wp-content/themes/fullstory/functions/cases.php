...
function cases() { 
	...
	register_post_type( 'cases', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Cases', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Case', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Cases', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Case', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Cases', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Case', 'jointswp'), /* New Display Title */
			'view_item' => __('View Case', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Case', 'jointswp'), /* Search Custom Type Title */ 
			...
			'has_archive' => 'cases', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('post_tag', 'cases');
